...
- Rivers and streams work exactly like trails: chain river segments end-to-end along the long axis of each box (~2 cells wide, e.g. {"pieceId":"river","x":0,"y":5,"width":10,"height":2}). A river flows THROUGH the scene — it must enter at one map edge and exit at another. If the party's route crosses the river, place a bridge piece at the crossing.
