...
export async function generateSkillsAction({ archetype, race, attributes, appearance, background, personality, motivation, backstory }: GenerateSkillsInput): Promise<GenerateSkillsResult> {
  try {
    let attributesText = ""
    if (attributes) {
