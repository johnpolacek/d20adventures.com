  ...
  return (
    <div className="flex min-h-screen flex-col relative">
      <div className="fade-in delay-[2s] relative z-10">
        <ImageHeader imageUrl={getImageUrl(setting.image)} title={setting.name} subtitle="Adventures" imageAlt={setting.name} />
        <div className="max-w-4xl xl:max-w-6xl mx-auto -mt-32 relative z-10 whitespace-pre-line">
          {isQuickStart ? (
            <div className="mb-8 text-center">
              ...
              <h4 className="inline-block font-bold bg-black/50 px-8 py-2 rounded text-base text-amber-400/90 font-display mt-8 text-center tracking-wider font-bold">Intro Adventures</h4>
                      ...
                      <CardContent className="flex-1 flex flex-col">
                        <div className="relative z-10 flex-1 flex flex-col">
                          ...
                          <div className="mt-4 mb-6 w-full flex justify-center">
                            <Link href={`/settings/${settingId}/${adventure.id}/character-select`}>
              ...
              {publishedAdventures[1] && (
                <>
                  ...
                  <div key={publishedAdventures[1].id} className="block h-full w-full mx-auto">
                    <Card className="w-full h-full bg-black/80 border-white/20 hover:scale-[1.01] hover:bg-black/90 ring-[6px] ring-black hover:ring-8 hover:ring-primary-500 transition-colors cursor-pointer transition-all duration-500 ease-in-out p-0 overflow-hidden flex flex-col">
                      ...
                      <CardContent className="flex-1 flex flex-col">
                        <div className="relative z-10 flex-1 flex flex-col">
                          ...
                          <div className="mt-4 mb-6 w-full flex justify-center">
                            <Link href={`/settings/${settingId}/${publishedAdventures[1].id}/character-select`}>
                              <Button variant="epic" size="sm" className="text-sm">
                                Play
                              </Button>
                            </Link>
